...
public class ChopstickCollisionLeftSphere : MonoBehaviour {
    ...
    void OnTriggerEnter(Collider collision)
    {
        ...
        if (collision.gameObject.GetComponent<Grabbable>() != null && my_sticks.grabbing == false)
        {
            ...
            my_sticks.left_target = collision.gameObject.GetComponent<Grabbable>();
        }
        else if (collision.gameObject.GetComponentInParent<Grabbable>() != null && my_sticks.grabbing == false)
        {
            ...
            my_sticks.left_target = collision.gameObject.GetComponentInParent<Grabbable>();
        }
    }
