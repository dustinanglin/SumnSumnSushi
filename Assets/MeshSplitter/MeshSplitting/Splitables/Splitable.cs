            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                if (newMesh != null)
                {
                    ...
                    if (ownBody != null && newBody != null)
                    {
                        ...
                        //This is only for fast moving things :D, should probably make this a separate function
                        newBody.velocity = Vector3.ClampMagnitude(ownBody.velocity,0);
                        newBody.angularVelocity = Vector3.ClampMagnitude(ownBody.angularVelocity,0);
