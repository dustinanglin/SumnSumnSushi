...
// Internal C# wrapper for OVRPluginFixed.

internal static class OVRPluginFixed
{
	...
	public static System.Version version
	{
		get {
			if (_version == null)
			{
				...
				// Unity 5.1.1f3-p3 have OVRPluginFixed version "0.5.0", which isn't accurate.
				if (_version == OVRP_0_5_0.version)
					_version = OVRP_0_1_0.version;

				if (_version > _versionZero && _version < OVRP_1_3_0.version)
					throw new PlatformNotSupportedException("Oculus Utilities version " + wrapperVersion + " is too new for OVRPluginFixed version " + _version.ToString () + ". Update to the latest version of Unity.");
			}
	...
	{
		get {
				return OVRP_1_1_0.ovrp_GetInitialized() == OVRPluginFixed.Bool.True;
		}
	}
	...
	public static bool chromatic
	{
		get {
			if (version >= OVRP_1_7_0.version)
				return OVRP_1_7_0.ovrp_GetAppChromaticCorrection() == OVRPluginFixed.Bool.True;
	...
	{
		get { return OVRP_1_1_0.ovrp_GetAppMonoscopic() == OVRPluginFixed.Bool.True; }
	...
	public static bool useIPDInPositionTracking
	{
		get {
			if (version >= OVRP_1_6_0.version)
				return OVRP_1_6_0.ovrp_GetTrackingIPDEnabled() == OVRPluginFixed.Bool.True;
	...
	public static bool headphonesPresent { get { return OVRP_1_3_0.ovrp_GetSystemHeadphonesPresent() == OVRPluginFixed.Bool.True; } }
	...
	public static string audioOutId
	{
		get
		{
				try
				{
					...
					if (ptr != IntPtr.Zero)
					{
						GUID nativeGuid = (GUID)Marshal.PtrToStructure(ptr, typeof(OVRPluginFixed.GUID));
	...
	public static bool GetBoundaryConfigured()
	{
		if (version >= OVRP_1_8_0.version)
		{
			return OVRP_1_8_0.ovrp_GetBoundaryConfigured() == OVRPluginFixed.Bool.True;
		}
		else
		{
			return false;
	...
	public static bool SetBoundaryLookAndFeel(BoundaryLookAndFeel lookAndFeel)
	{
		if (version >= OVRP_1_8_0.version)
		{
			return OVRP_1_8_0.ovrp_SetBoundaryLookAndFeel(lookAndFeel) == OVRPluginFixed.Bool.True;
		}
		else
		{
			return false;
	...
	public static bool ResetBoundaryLookAndFeel()
	{
		if (version >= OVRP_1_8_0.version)
		{
			return OVRP_1_8_0.ovrp_ResetBoundaryLookAndFeel() == OVRPluginFixed.Bool.True;
		}
		else
		{
			return false;
	...
	public static bool GetBoundaryGeometry2(BoundaryType boundaryType, IntPtr points, ref int pointsCount)
	{
		...
		{
			return OVRP_1_9_0.ovrp_GetBoundaryGeometry2(boundaryType, points, ref pointsCount) == OVRPluginFixed.Bool.True;
		}
		else
		{
			pointsCount = 0;
	...
	public static bool ResetAppPerfStats()
	{
		if (version >= OVRP_1_9_0.version)
		{
			return OVRP_1_9_0.ovrp_ResetAppPerfStats() == OVRPluginFixed.Bool.True;
		}
		else
		{
			return false;
	...
	public static bool SetDesiredEyeTextureFormat(EyeTextureFormat value)
	{
		if (version >= OVRP_1_11_0.version)
		{
			return OVRP_1_11_0.ovrp_SetDesiredEyeTextureFormat(value) == OVRPluginFixed.Bool.True;
		}
		else
		{
			return false;
	...
	public static bool GetBoundaryVisible()
	{
		if (version >= OVRP_1_8_0.version)
		{
			return OVRP_1_8_0.ovrp_GetBoundaryVisible() == OVRPluginFixed.Bool.True;
		}
		else
		{
			return false;
	...
	public static bool SetBoundaryVisible(bool value)
	{
		if (version >= OVRP_1_8_0.version)
		{
			return OVRP_1_8_0.ovrp_SetBoundaryVisible(ToBool(value)) == OVRPluginFixed.Bool.True;
		}
		else
		{
			return false;
	...
	{
		return (b) ? OVRPluginFixed.Bool.True : OVRPluginFixed.Bool.False;
	}
	...
	private const string pluginName = "OVRPluginFixed";
