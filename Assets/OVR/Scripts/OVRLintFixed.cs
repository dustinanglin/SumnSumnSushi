...
/// </summary>
public static class OVRLintFixed
{
	...
	static void CheckRuntimeCommonIssues()
	{
		...
		if (QualitySettings.antiAliasing != OVRManagerFixed.display.recommendedMSAALevel &&
			EditorUtility.DisplayDialog("Optimize MSAA?", "Multisample antialiasing level " + OVRManagerFixed.display.recommendedMSAALevel + " is recommended for optimal quality and performance.", "Use recommended", "Skip"))
			QualitySettings.antiAliasing = OVRManagerFixed.display.recommendedMSAALevel;
