...
/// </summary>
public class OVRManagerFixed : MonoBehaviour
{
	...
	/// </summary>
	public static OVRManagerFixed instance { get; private set; }
	...
	public static EyeTextureFormat eyeTextureFormat
	{
		get
		{
			return (OVRManagerFixed.EyeTextureFormat)OVRPlugin.GetDesiredEyeTextureFormat();
		}
	...
	[SerializeField]
	private OVRManagerFixed.TrackingOrigin _trackingOriginType = OVRManagerFixed.TrackingOrigin.EyeLevel;
	/// <summary>
	/// Defines the current tracking origin type.
	/// </summary>
	public OVRManagerFixed.TrackingOrigin trackingOriginType
	{
		get {
			if (!isHmdPresent)
				return _trackingOriginType;

			return (OVRManagerFixed.TrackingOrigin)OVRPlugin.GetTrackingOriginType();
		}
...
#region Unity Messages
	...
	private void Update()
	{
		...
		if (OVRPlugin.shouldRecenter)
			OVRManagerFixed.display.RecenterPose();
	...
	public void ReturnToLauncher()
	{
		...
		OVRManagerFixed.PlatformUIConfirmQuit();
	}
