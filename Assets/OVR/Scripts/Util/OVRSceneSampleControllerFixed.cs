...
/// </summary>
public class OVRSceneSampleControllerFixed : MonoBehaviour
{
    /// <summary>
    ...
    private OVRPlayerControllerFixed playerController = null;

    // Handle to OVRCameraRig
    private OVRCameraRigFixed cameraController = null;
    ...
    void Awake()
    {
        ...
        OVRCameraRigFixed[] cameraControllers;
        cameraControllers = gameObject.GetComponentsInChildren<OVRCameraRigFixed>();
        ...
        OVRPlayerControllerFixed[] playerControllers;
        playerControllers = gameObject.GetComponentsInChildren<OVRPlayerControllerFixed>();
    ...
    void UpdateVisionMode()
    {
        if (Input.GetKeyDown(KeyCode.F2))
        {
            ...
            OVRManagerFixed.tracker.isEnabled = visionMode;            
        }
    }
