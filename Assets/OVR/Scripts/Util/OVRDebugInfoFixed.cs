...
/// </summary>
public class OVRDebugInfoFixed : MonoBehaviour
{
    ...
    void UpdateIPD()
    {
        strIPD = System.String.Format("IPD (mm): {0:F4}", OVRManagerFixed.profile.ipd * 1000.0f);
    }
    ...
    {
        float eyeHeight = OVRManagerFixed.profile.eyeHeight;
	...
	{
		float eyeDepth = OVRManagerFixed.profile.eyeDepth;
    ...
    void UpdateFOV()
    {
        OVRDisplay.EyeRenderDesc eyeDesc = OVRManagerFixed.display.GetEyeRenderDesc(VR.VRNode.LeftEye);
    ...
    {
		OVRDisplay.EyeRenderDesc leftEyeDesc = OVRManagerFixed.display.GetEyeRenderDesc(VR.VRNode.LeftEye);
		OVRDisplay.EyeRenderDesc rightEyeDesc = OVRManagerFixed.display.GetEyeRenderDesc(VR.VRNode.RightEye);
    ...
    void UpdateLatencyValues()
    {
            ...
            OVRDisplay.LatencyData latency = OVRManagerFixed.display.latency;
