...
/// <summary>
/// Add OVROverlayFixed script to an object with an optional mesh primitive
...
public class OVROverlayFixed : MonoBehaviour
{
	...
	internal static OVROverlayFixed[] instances = new OVROverlayFixed[maxInstances];
